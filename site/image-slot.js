...
(() => {
  ...
  const stylesheet =
    ...
    // Static-export patch: was touch-action:none, which blocked native touch
    // scrolling whenever a finger landed on a photo (reframe pan lives on
    // .spill, so the frame img never needs to own touch gestures).
